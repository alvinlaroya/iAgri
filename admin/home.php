            ...
            <div class="inner">
              <?php
                if($admin['id'] == 1) {
                  ...
                  $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN products ON products.id=details.product_id WHERE details.seller_id = ".$admin['id']."");
                }
                $stmt->execute();
            ...
            <div class="inner">
              <?php
                if($admin['id'] == 1) {
                  ...
                  $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN sales ON sales.id=details.sales_id LEFT JOIN products ON products.id=details.product_id WHERE sales_date=:sales_date AND details.seller_id = ".$admin['id']."");
                }
  ...
  for( $m = 1; $m <= 12; $m++ ) {
    try{
      if($admin['id'] == 1) {
        ...
        $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN sales ON sales.id=details.sales_id LEFT JOIN products ON products.id=details.product_id WHERE MONTH(sales_date)=:month AND YEAR(sales_date)=:year AND sales.seller_id = ".$admin['id']."");
      }
