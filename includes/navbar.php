  ...
  <nav class="navbar navbar-static-top" style="background-color: white">
    <div class="container">
      <div class="navbar-header">
        <a href="index.php" class="navbar-brand" style="color: black"><b>iAgri</b></a>
        ...
        <ul class="nav navbar-nav">
          ...
          <?php
            if(isset($_SESSION['user'])){
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: black">Account <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li><a href="wishlist_view.php"><i class='fa fa-heart' style="color: black"></i></a></li>
          <?php
            if(isset($_SESSION['user'])){
              ...
              echo '
                <li class="dropdown user user-menu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs" style="color: black">'.$user['firstname'].' '.$user['lastname'].'</span>
                  </a>
                  <ul class="dropdown-menu">
                    <!-- User image -->
